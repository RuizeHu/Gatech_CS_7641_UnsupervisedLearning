...
for k in range(1,30):
    ...
    em.fit(x_train_scaled_reduced)
    log_likelihood.append(em.score(x_train_scaled_reduced))
    aic.append(em.aic(x_train_scaled_reduced))
    bic.append(em.bic(x_train_scaled_reduced))
