...
print("Clustering + ICA time", end-start)
train_scores_mean = np.mean(train_scores, axis=1)
train_scores_std = np.std(train_scores, axis=1)
test_scores_mean = np.mean(test_scores, axis=1)
test_scores_std = np.std(test_scores, axis=1)
...
axes[1].set_title("Clustering + ICA")
...
print("Clustering + RP time", end-start)
train_scores_mean = np.mean(train_scores, axis=1)
train_scores_std = np.std(train_scores, axis=1)
test_scores_mean = np.mean(test_scores, axis=1)
test_scores_std = np.std(test_scores, axis=1)
...
axes[3].set_title("Clustering + RP")
...
print("Clustering + KPCA time", end-start)
train_scores_mean = np.mean(train_scores, axis=1)
train_scores_std = np.std(train_scores, axis=1)
test_scores_mean = np.mean(test_scores, axis=1)
test_scores_std = np.std(test_scores, axis=1)
...
axes[5].set_title("Clustering + KPCA")
axes[5].set_xlabel("Training examples")
axes[5].set_ylabel("Score")

axes[5].set_xlabel("Numer of training samples")
axes[5].set_ylabel("Score")
axes[5].grid()
axes[5].fill_between(train_sizes, train_scores_mean - train_scores_std,
                        train_scores_mean + train_scores_std, alpha=0.1,
                        color="r")
axes[5].fill_between(train_sizes, test_scores_mean - test_scores_std,
                        test_scores_mean + test_scores_std, alpha=0.1,
                        color="g")
axes[5].plot(train_sizes, train_scores_mean, 'o-', color="r",
                label="Training score")
axes[5].plot(train_sizes, test_scores_mean, 'o-', color="g",
                label="Cross-validation score")
axes[5].legend(loc="best")
axes[5].set_ylim(0.6,1.0)
